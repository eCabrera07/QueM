...
class AttachmentEditorTest {
    ...
    @Test
    fun hidesDriveAttachmentTypesWhenRequested() {
        compose.setContent {
            AttachmentEditor(
                onAddText = {},
                onAddLink = {},
        ...
        compose.onNodeWithText("Text").assertIsDisplayed()
        compose.onNodeWithText("Link").assertIsDisplayed()
        compose.onAllNodesWithText("Drive file").assertCountEquals(0)
        compose.onAllNodesWithText("Drive folder").assertCountEquals(0)
    }
}
